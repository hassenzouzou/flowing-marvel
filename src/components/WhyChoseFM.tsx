  ...
  return (
    <div className="flex flex-col justify-center items-center pb-[100px]">
      ...
      <div className="bg-gradient-to-r from-[#007EFF] to-[#0BFAE6] p-[1px] rounded-[20px] relative font-['Sora'] sm:w-[73%] w-[90%] ">
        <div className="flex flex-col items-center sm:h-auto bg-[#0F0F0F] rounded-[20px] sm:py-[30px] py-[12px] sm:px-[30px] px-[15px]">
          <img className="absolute top-0" src={cardsBg} alt="" />

          <p className="text-[#808080] sm:w-[90%] w-[95%] sm:text-[31px] text-[23px] text-center ">
          ...
          <div className="flex flex-col justify-between items-center font-normal font-['Sora'] text-[#FFFF] mt-[5%]">
